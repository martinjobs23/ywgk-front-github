    ...
    <vab-card shadow="hover">
      ...
      >
        ...
        <el-table-column
          ...
          show-overflow-tooltip
        />
        <el-table-column label="终端IP" prop="dev_ip" show-overflow-tooltip />
        <el-table-column
          label="终端HASH"
          prop="dev_hash"
          show-overflow-tooltip
...
<script>
  import { getSoftwareList, getSoftwareListLog } from '@/api/systemLog/getPage'
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      const handleExport = async () => {
        ...
        const { data } = await getSoftwareListLog()
      ...
      const fetchData = async () => {
        state.listLoading = true
        const { data } = await getSoftwareList(state.queryForm)
