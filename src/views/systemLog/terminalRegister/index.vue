    ...
    <vab-card shadow="hover">
      ...
      >
        ...
        <el-table-column
          ...
          sortable
        />
        <el-table-column label="详细" prop="detail" show-overflow-tooltip />
...
<script>
  import { getaccountlogs, getTerminalListLog } from '@/api/systemLog/getPage'
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      const handleExport = async () => {
        ...
        const { data } = await getTerminalListLog()
      ...
      const fetchLogData = async () => {
        state.listLoading = true
        const { data } = await getaccountlogs(state.queryForm)
