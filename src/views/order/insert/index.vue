          ...
          <el-col :span="12">
            ...
            <el-form-item label="业务模式：" prop="order_type">
              <el-tree-select
                ...
                filterable
                placeholder="选择业务模式："
                :props="{ label: 'inspection_ticket', value: 'id' }"
        ...
        >
          <vab-query-form>
            <vab-query-form-top-panel :span="12">
              ...
              <el-button :icon="Search" type="primary" @click="deleteOperator">
                删除运维人员
              </el-button>
            </vab-query-form-top-panel>
        ...
        >
          ...
          >
            ...
            <el-table-column
              ...
              sortable
            />
            <el-table-column label="特权账号" prop="tqzh" show-overflow-tooltip>
          ...
          <!-- <el-pagination
            ...
            :small="small"
            :total="deviceTotal"
            @current-change="handleDevicePageCurrentChange"
...
<script>
  ...
  // 业务模式接口
  import { getPage as getPattern } from '@/api/strategy/ywms/pattern'
  import {
    Plus,
    Delete,
    DArrowLeft,
  ...
  export default defineComponent({
    name: 'DeviceBlack',
    components: {
      Edit: defineAsyncComponent(() => import('./components/UserInfo.vue')),
