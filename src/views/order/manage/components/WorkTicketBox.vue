    ...
    <vab-card shadow="hover">
      <vab-query-form>
        <vab-query-form-top-panel :span="12">
          ...
          <!-- <el-button plain type="primary" @click="showAddModal = true">
...
<script>
  import { getTicketList } from '@/api/order/orderTicketManage'
  import {
    Plus,
    // Upload,
    // Edit,
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      const fetchData = async () => {
        state.listLoading = true
        const { data } = await getTicketList(state.searchForm)
