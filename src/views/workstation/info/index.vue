  ...
  <div class="info-management-container">
    <vab-card shadow="hover">
      ...
      >
        ...
        <!--            />-->
        <!--            <vab-icon-->
        <!--              v-if="row.logined == 0 && row.online_time"-->
        <!--              icon="checkbox-circle-fill"-->
        <!--              style="color: #cccccc"-->
        <!--            />-->
        <!--            <vab-icon-->
        <!--              v-if="row.logined == 0 && row.online_time == null"-->
        <!--              icon="close-circle-line"-->
        <!--            />-->
        <!--          </template>-->
        <!--        </el-table-column>-->
        ...
        >
          <template #default="{ row }">
            <vab-icon v-if="row.disabled == 1" icon="close-circle-line" />
            <vab-icon
              v-if="row.disabled == 0"
              icon="checkbox-circle-fill"
              style="color: #92ca41"
            />
            <!--            <vab-icon-->
            <!--              v-if="row.disabled == 0 && row.online_time == null"-->
            <!--              icon="close-circle-line"-->
            <!--            />-->
            <span v-if="row.disabled == 0">在用</span>
            <span v-if="row.disabled == 1">禁用</span>
            <span v-if="![0, 1].includes(row.disabled)">状态异常</span>
          </template>
        </el-table-column>
        <el-table-column
          label="备注"
...
<script>
  ...
  import { getCheckList, radRevoke } from '@/api/workstation/manager'
