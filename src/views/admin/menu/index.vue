    ...
    <vab-card shadow="hover">
      ...
      >
        ...
        <el-table-column
          ...
          sortable
        />
        <el-table-column align="center" label="隐藏" sortable width="70">
          <template #default="{ row }">
            {{ row.hidden ? '是' : ' ' }}
          </template>
        </el-table-column>
        ...
        <el-table-column align="center" label="固定" sortable width="70">
          <template #default="{ row }">
            {{ row.noClosable ? '是' : ' ' }}
          </template>
        </el-table-column>
        <el-table-column align="center" label="缓存" sortable width="70">
          <template #default="{ row }">
            {{ row.noKeepAlive ? ' ' : '是' }}
          </template>
        </el-table-column>
...
<script>
  import { doDelete, getTree, setSort } from '@/api/admin/menu'
  import {
    Plus,
    Edit,
    Delete,
  ...
  export default defineComponent({
    name: 'Menu',
    components: {
      Edit: defineAsyncComponent(() => import('./components/MenuEdit')),
    },
    setup() {
